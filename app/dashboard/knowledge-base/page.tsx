...
const KnowledgeBasePage = () => {
  ...
  const handleDownloadTemplate = async (areaId: string, templateType: string = 'template') => {
    try {
      ...
      alert('Unable to download template. Please try again later.')
    }
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1">
          {showAIChat && (
            <div className="polaris-card sticky top-8">
              ...
              <div className="mb-6">
                <textarea
                  ...
                  rows={3}
                  placeholder="Ask me anything about business compliance, processes, or best practices..."
                    ...
                    {recentAI.map((ai, index) => (
                      <div key={index} className="bg-gray-50 rounded-lg p-3">
                        ...
                        <div className="text-sm text-gray-600 mb-2">
                          {ai.response.length > 150 
                            ? ai.response.substring(0, 150) + '...'
                            : ai.response
                          }
                        </div>
                        <div className="text-xs text-gray-500">
                          {new Date(ai.timestamp).toLocaleTimeString()}
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              {recentAI.length === 0 && (
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-gray-500">
                    Ask your first question to get personalized assistance!
                  </p>
                </div>
              )}
            </div>
