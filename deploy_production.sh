...
for i in {1..5}; do
    if curl -f -s https://nextjs-mongo-polaris.preview.emergentagent.com/api/system/health > /dev/null; then
...
for endpoint in "${ENDPOINTS[@]}"; do
    if curl -f -s "https://nextjs-mongo-polaris.preview.emergentagent.com$endpoint" > /dev/null; then
        echo "✅ $endpoint - OK"
    else
...
echo "======================="
echo "✅ Backend: https://nextjs-mongo-polaris.preview.emergentagent.com/api"
