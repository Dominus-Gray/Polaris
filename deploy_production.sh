...
for i in {1..5}; do
    if curl -f -s https://polaris-migrate.preview.emergentagent.com/api/system/health > /dev/null; then
...
for endpoint in "${ENDPOINTS[@]}"; do
    if curl -f -s "https://polaris-migrate.preview.emergentagent.com$endpoint" > /dev/null; then
        echo "✅ $endpoint - OK"
    else
...
echo "======================="
echo "✅ Backend: https://polaris-migrate.preview.emergentagent.com/api"
