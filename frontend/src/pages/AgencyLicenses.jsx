    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border p-6 shadow-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="btn btn-sm" onClick={()=>navigator.clipboard.writeText('Polaris Registration: https://smallbiz-assist.preview.emergentagent.com\nUse the attached CSV of codes (single-use).')}>Copy Email Body</button>
        </div>
...
function InviteCompanyPanel({ licenses }){
  ...
  const prepareEmail = () => {
    ...
    const lines = [
      ...
      'Download CSV: ' + url,
      '',
      'Registration link: https://smallbiz-assist.preview.emergentagent.com (Sign Up → Enter 10-digit license code)',
      '',
      'Best regards,',
      'Your Agency'
    ];
...
function GenerateEmailButton({ licenses }){
  const handleClick = () => {
    ...
    navigator.clipboard.writeText('Polaris Registration: https://smallbiz-assist.preview.emergentagent.com\nInclude the CSV attachment downloaded from your browser.');
