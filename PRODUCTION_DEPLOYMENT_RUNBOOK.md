...
curl -s https://smallbiz-assist.preview.emergentagent.com/api/health/system | jq .
```
...
# Verify deployment
curl -s https://smallbiz-assist.preview.emergentagent.com/api/health/system
```
...
watch -n 30 'curl -s https://smallbiz-assist.preview.emergentagent.com/api/health/system | jq .status'
```
...
curl -s "https://smallbiz-assist.preview.emergentagent.com/api/health/external" | jq .services.stripe
...
```bash
# Test QA credentials
curl -X POST https://smallbiz-assist.preview.emergentagent.com/api/auth/login \
...
curl -s "https://smallbiz-assist.preview.emergentagent.com/api/health/database" | jq .
...
curl -s "https://smallbiz-assist.preview.emergentagent.com/api/health/external" | jq .services.emergent_llm
